...
public class CRCRMutator implements MethodMutatorFactory {
  ...
  private final class CRCRVisitor extends MethodVisitor {
    private final MutationContext context;

    CRCRVisitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCRMutator.this, "CRCR Substituted " + constant + " with "
              + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCRVisitor(context, methodVisitor);
  }
