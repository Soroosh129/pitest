 ...
 */
public class CRCR4Mutator implements MethodMutatorFactory {

  private final class CRCR4Visitor extends MethodVisitor {
    private final MutationContext context;

    CRCR4Visitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCR4Mutator.this, "CRCR Substituted " + constant + " with "
              + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCR4Visitor(context, methodVisitor);
  }
