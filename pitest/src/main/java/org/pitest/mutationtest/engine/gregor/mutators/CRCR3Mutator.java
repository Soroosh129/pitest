 ...
 */
public class CRCR3Mutator implements MethodMutatorFactory {

  private final class CRCR3Visitor extends MethodVisitor {
    private final MutationContext context;

    CRCR3Visitor(final MutationContext context,
    ...
    private void mutate(final Integer constant) {
      ...
      case Short.MAX_VALUE:
        ...
        break;
      default:
        replacement = Integer.valueOf(-constant);
        break;
      }
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCR3Mutator.this, "CRCR Substituted " + constant + " with "
              + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCR3Visitor(context, methodVisitor);
  }
