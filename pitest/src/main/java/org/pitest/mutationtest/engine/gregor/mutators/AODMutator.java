...
public enum AODMutator implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new AODMutatorVisitor(this, methodInfo, context, methodVisitor);
  }
...
class AODMutatorVisitor extends AbstractInsnMutator {

  private static final String                            MESSAGE   = "replace expression";
  private static final Map<Integer, ZeroOperandMutation> MUTATIONS = new HashMap<Integer, ZeroOperandMutation>();

  static {
    MUTATIONS.put(Opcodes.FDIV, new InsnSubstitution(Opcodes.POP, MESSAGE));
    MUTATIONS.put(Opcodes.FMUL, new InsnSubstitution(Opcodes.POP, MESSAGE));
