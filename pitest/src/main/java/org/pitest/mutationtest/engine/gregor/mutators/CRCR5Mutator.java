 ...
 */
public class CRCR5Mutator implements MethodMutatorFactory {

  private final class CRCR5Visitor extends MethodVisitor {
    private final MutationContext context;

    CRCR5Visitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCR5Mutator.this, "CRCR Substituted " + constant + " with "
              + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCR5Visitor(context, methodVisitor);
  }
