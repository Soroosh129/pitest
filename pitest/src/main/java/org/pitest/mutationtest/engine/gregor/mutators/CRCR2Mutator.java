 ...
 */
public class CRCR2Mutator implements MethodMutatorFactory {

  private final class CRCR2Visitor extends MethodVisitor {
    private final MutationContext context;

    CRCR2Visitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCR2Mutator.this, "CRCR Substituted " + constant + " with "
              + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCR2Visitor(context, methodVisitor);
  }
